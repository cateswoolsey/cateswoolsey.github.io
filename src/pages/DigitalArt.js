      ...
      <div className="digital-art-page">
        ...
        <div className="project-frame fade-in-section">
          <div className="project-content">
            ...
            <div className="project-caption">
              <h3>Star Dance</h3>
              <p>A generative, audio-reactive experience where stars pulsate and shift in response to space-themed music. Click the image and press "p" to play or pause. Drag to pan around, while zooming in and out to explore the galaxy.</p>
            </div>
          </div>
        </div>
      </div>
